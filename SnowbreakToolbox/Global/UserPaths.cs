...
public static class UserPaths
{
    ...
    public static readonly string ModConfFile = Path.Combine(ConfPath, "ModConfig.json");
    public static readonly string CharacterCodeFile = Path.Combine(ConfPath, "CharacterCodes.json");
